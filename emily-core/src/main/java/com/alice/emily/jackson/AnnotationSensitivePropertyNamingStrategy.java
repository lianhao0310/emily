...
public class AnnotationSensitivePropertyNamingStrategy extends PropertyNamingStrategy {
    ...
    public String nameForConstructorParameter(MapperConfig<?> config,
                                              ...
                                              String defaultName) {
        if (ctorParam != null && ctorParam.getDeclaringClass().isAnnotationPresent(JsonSnakeCase.class)) {
    ...
    public String nameForField(MapperConfig<?> config,
                               ...
                               String defaultName) {
        if (field != null && field.getDeclaringClass().isAnnotationPresent(JsonSnakeCase.class)) {
    ...
    public String nameForGetterMethod(MapperConfig<?> config,
                                      ...
                                      String defaultName) {
        if (method != null && method.getDeclaringClass().isAnnotationPresent(JsonSnakeCase.class)) {
