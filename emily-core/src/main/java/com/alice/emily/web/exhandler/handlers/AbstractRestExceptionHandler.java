...
public abstract class AbstractRestExceptionHandler<E extends Exception, T> implements RestExceptionHandler<E, T> {
    ...
    public abstract T createBody(@Nonnull E ex, @Nonnull HttpServletRequest req);
    ...
    protected HttpHeaders createHeaders(@Nonnull E ex, @Nonnull HttpServletRequest req) {
    ...
    protected void logException(E ex, HttpServletRequest req) {
        ...
        sb.append("\nHeaders:\n");
        List<String> headerNames = EnumerationUtils.toList(req.getHeaderNames());
