...
public abstract class AbstractAnnotationBeanPostProcessor implements BeanPostProcessor {
    ...
    @Override
    public final Object postProcessBeforeInitialization(@Nonnull Object bean, String beanName) {
    ...
    @Override
    public final Object postProcessAfterInitialization(@Nonnull Object bean, String beanName) {
