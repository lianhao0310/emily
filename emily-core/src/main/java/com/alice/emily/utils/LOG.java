...
public class LOG {
    ...
    public static final Logger WEB = getLogger("emily.web");
...
//            DefaultRolloverStrategy strategy = DefaultRolloverStrategy.createStrategy("1", null, null, null, null, true, configuration);
     ...
     */
    public static synchronized Logger updateLogger(@NonNull String name, @NonNull String level,
                                                   String location, boolean burst) {
